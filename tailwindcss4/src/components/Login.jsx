  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 font-sans">
      <div className="flex flex-wrap h-screen">
        <div className="w-full md:w-2/3 h-full flex flex-col items-center justify-center bg-white p-8 md:p-12">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label
                  htmlFor="email"
                  className="b lock text-sm font-medium text-gray-700"
                >
                  Email Address
                </label>
              ...
              <div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-9 align-center border border-transparent rounded-md shadow-sm text-m font-medium text-white bg-teal-600 hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-300 disabled:opacity-60"
                >
        ...
        <div className="hidden md:flex w-1/3 h-full bg-gradient-to-br from-teal-800 to-teal-900 items-center justify-center p-12 relative overflow-hidden">
          ...
          <div className="z-10 text-white text-center max-w-lg">
            <h2 className="text-4xl align-center font-bold leading-tight mb-6">
